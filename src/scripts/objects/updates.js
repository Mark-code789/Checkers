class Updates {
	static version = "30.21.218.502.3";
	static updatesLog = new Map([
		...
		["30.21.218.502.3", ["Added 2 new levels per version.", "Improved game performance.", "Improved game difficulty", "Change online match connectivity", "Fixed interface breaking on different size screens", "Added other features, discover by yourself"]], 
	]);
